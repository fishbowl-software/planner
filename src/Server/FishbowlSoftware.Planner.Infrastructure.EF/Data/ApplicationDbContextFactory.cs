    ...
    public ApplicationDbContext CreateDbContext(string[] args)
    {
        ...
        var contextOptions = provider switch
        {
            "Sqlite" => new ApplicationDbContextOptions
            {
                ...
                ConnectionString = "Data Source=.\\SQLEXPRESS; Database=PlannerDB; Integrated Security=true; TrustServerCertificate=true;" //"Data Source=Data\\MyDatabase.sqlite"
            },
            "SqlServer" => new ApplicationDbContextOptions
            {
                DatabaseProvider = "SqlServer",
                ConnectionString = "Data Source=.\\SQLEXPRESS; Database=PlannerDB; Integrated Security=true; TrustServerCertificate=true;" //"Data Source=.\\SQLEXPRESS; Database=MyDatabase; Integrated Security=true; TrustServerCertificate=true"
            },
            "PostgreSql" => new ApplicationDbContextOptions
            {
                DatabaseProvider = "PostgreSql",
                ConnectionString = "Data Source=.\\SQLEXPRESS; Database=PlannerDB; Integrated Security=true; TrustServerCertificate=true;" //"Data Source=localhost; Port=5432; Database=MyDatabase; Username=postgres; Password=postgres"
            },
            "MySql" => new ApplicationDbContextOptions
            {
                DatabaseProvider = "MySql",
                ConnectionString = "Data Source=.\\SQLEXPRESS; Database=PlannerDB; Integrated Security=true; TrustServerCertificate=true;" //"Data Source=localhost; Port=3306; Database=MyDatabase; Username=root; Password=root"
            },
