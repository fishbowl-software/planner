using FishbowSoftware.Planner.API.Middlewares;
using FishbowSoftware.Planner.Application;
using FishbowSoftware.Planner.Domain;
using FishbowSoftware.Planner.Infrastructure;
using Serilog;

namespace FishbowSoftware.Planner.API
{
